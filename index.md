---
layout: default
title: رو به کمال — تجربه‌ها، یادداشت‌ها و آموخته‌ها
description: رو به کمال؛ وبلاگ شخصی درباره تجربه‌ها، یادداشت‌ها، یادگیری و زندگی آگاهانه.
permalink: /
---
...
>
  <div class="container">
    ...
    {% if published_posts.size > 0 %}
      ...
      <!-- پیام نبودن نوشته در دسته انتخاب‌شده -->
      <div
        class="latest-empty"
        id="latestEmpty"
        role="status"
    ...
    {% else %}
      ...
      <!-- حالت نبود هیچ نوشته‌ای در سایت -->
