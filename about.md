    ...
    <div class="about-container">
      ...
      <div class="about-cards-grid">
        ...
        <article class="about-card">
          ...
          <h3>دانش و اندیشه</h3>
          <p>
            شامل کلام بزرگان ، مطالب علمی ، تفکر تحلیلی و کتابخوانی.
          </p>
        </article>
        ...
        <article class="about-card">
          ...
          <h3>کسب و کار</h3>
          <p>
            شامل مطالب نظری اقتصاد و روایت هایی از کسب و کار عملی.
          </p>
        </article>
        ...
        <article class="about-card">
          ...
          <h3>تحلیل و تفکر</h3>
          <p>
            ثبت تجارب خاص از رویدادهای ویژه ای که برای فرار از ملال پیش می آوریم.
          </p>
        </article>
